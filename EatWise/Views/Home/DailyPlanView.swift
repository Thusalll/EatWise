                    ...
                    if selectedPlanType == 0 {
                        HStack {
                            Button(action: {
                                ...
                                print("userModel: \(userViewModel.userModel)")
                            }) {
                        ...
                        if Calendar.current.isDate(selectedDate, inSameDayAs: Date()) {
                            ForEach(userViewModel.mealPlan.keys.sorted(), id: \.self) { mealType in
                                if let meals = userViewModel.mealPlan[mealType], !meals.isEmpty {
                                       ...
                                       //                 userViewModel.saveMealPlansToFirebase(date: self.selectedDate, userID: userViewModel.userModel?.id ?? "", dailyPlan: userViewModel.mealPlan, weeklyPlan: userViewModel.weeklyMealPlan)
                                                    }
                                                )
                                                .padding(.top)
                                            } else {
                        ...
                        HStack {
                            ...
                            VStack{
                                Button {
                                    ...
                                    print(userViewModel.mealPlan.count)
